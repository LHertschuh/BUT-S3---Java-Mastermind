...
- L'application est un jeu de mastermind, un jeu ou l'on doit deviner une combinaison de plusieurs couleurs avec l'aide d'indices.

# Lancement de l'application
- Dans le dossier Application, faire la commande "java -jar a31-mastermind.jar"

# Projet
- Application faite dans le cadre d'un projet tutoré au 3ème semestre du BUT informatique à Robert Schuman. 
- Langage Java avec le modèle MVC 
- Conception et developpement fait en singleton 
- Durée du projet : 1 mois et demi

-------------------------------------

# Readme des consignes 
